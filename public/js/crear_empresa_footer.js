...
$(document).ready(function () {
  ...
  $("input[name='plan_seleccionado']").on("change", function () {
    $("#plan_label").html("Empresa " + $(this).parent(".container-radio").find("input[name='plan_seleccionado']:checked").val()); //SI EL PRECIO DEL PLAN SELECCIONADO ES MAS DE CERO MOSTRAR PERIODOS
