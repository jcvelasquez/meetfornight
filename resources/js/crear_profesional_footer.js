$(document).ready(function(){
    ...
    function checkSpecialKeys(e) { 
      ...
      $('#descripcion').on('keyup', function(event){   checkTextAreaMaxLength(this,event);  });
      ...
      dtTarifas = $('#tarifaxhoras').DataTable( {
          ...
          columns: [
              { title: "#", data: "id" },
              { title: "Tipo", data : "opcion_tarifa" },
              { title: "Tarifa", data: "costo_tarifa" },
              {
                  "mData": null,
                  "bSortable": false,
      ...
      $("#form-cuenta-profesional").validate({
        ...
        submitHandler: function(form, e) {
            ...
            $('input[name="preliminares[]"]:checked').each(function() { 
              arServicios.push( { "idservicio" : $(this).val() , "nombre_servicio" : "", "categoria_servicio" : "PRELIMINARES" } ); 
            }); 

            $('input[name="intimos[]"]:checked').each(function() { 
              arServicios.push( { "idservicio" : $(this).val() , "nombre_servicio" : "", "categoria_servicio" : "INTIMO" } ); 
            }); 

            $('input[name="otros[]"]:checked').each(function() { 
              arServicios.push( { "idservicio" : $(this).val() , "nombre_servicio" : "", "categoria_servicio" : "OTROS" } ); 
            }); 

            $('input[name="fetiches[]"]:checked').each(function() { 
              arServicios.push( { "idservicio" : $(this).val() , "nombre_servicio" : "", "categoria_servicio" : "FETICHE" } ); 
            }); 
     ...
     $('#estatura').jRange({
      ...
      $('.slider-horario').jRange({
          ...
          onstatechange: function (value) {
              ...
              switch( input.data("horas") ){
                    ...
                    case "horas_lunes" :  $('.fecha.lunes p.desde').html(desde);
                                          $('.fecha.lunes p.hasta').html(hasta);
                                          break;
                  case "horas_martes" :   $('.fecha.martes p.desde').html(desde);
                                          $('.fecha.martes p.hasta').html(hasta);
                                          break;
                case "horas_miercoles" :  $('.fecha.miercoles p.desde').html(desde);
                                          $('.fecha.miercoles p.hasta').html(hasta);
                                          break;
                  case "horas_jueves" :   $('.fecha.jueves p.desde').html(desde);
                                          $('.fecha.jueves p.hasta').html(hasta);
                                          break;
                  case "horas_viernes" :  $('.fecha.viernes p.desde').html(desde);
                                          $('.fecha.viernes p.hasta').html(hasta);
                                          break;
                  case "horas_sabado" :   $('.fecha.sabado p.desde').html(desde);
                                          $('.fecha.sabado p.hasta').html(hasta);
                                          break;
                  case "horas_domingo" :  $('.fecha.domingo p.desde').html(desde);
      ...
      $('input[name="horas_lunes"], input[name="horas_martes"], input[name="horas_miercoles"], input[name="horas_jueves"], input[name="horas_viernes"], input[name="horas_sabado"], input[name="horas_domingo"]').click(function(){ 
            ...
            switch( $(this).data("dia") ){
                    ...
                    case "lunes" :  $('input[name="slider_lunes"]').jRange('setValue', horas );
                    ...
                    case "martes" : $('input[name="slider_martes"]').jRange('setValue', horas );
                ...
                case "miercoles" :  $('input[name="slider_miercoles"]').jRange('setValue', horas );
                    ...
                    case "jueves" : $('input[name="slider_jueves"]').jRange('setValue', horas );
                  ...
                  case "viernes" :  $('input[name="slider_viernes"]').jRange('setValue', horas );
                    ...
                    case "sabado" : $('input[name="slider_sabado"]').jRange('setValue', horas );
                  ...
                  case "domingo" :  $('input[name="slider_domingo"]').jRange('setValue', horas );
      ...
      //INICIALIZAR ORIENTACION LESBIANA
      $("#raLESBIANA").prop('checked', true);
      $("#label_orientacion").html( "LESBIANA" );
