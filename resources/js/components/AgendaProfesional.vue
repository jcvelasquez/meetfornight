<template>
  <form action="#" method="post">
    <div class="bloques-de-perfil">
      ...
      <p>
        <strong class="precio-morado">La Agenda</strong> te permite propulsar tu anuncio nuevamente a las primeras posiciones y multiplicar de esta manera la visibilidad de tu anuncio y aumentar el número de contactos.
      </p>
      <p>
