...
<!-- 
    ...
    <div class="img-cargada" v-for="(foto, index) in arBanners" :key="foto.id">

        <div class="img-cargada-izq">
          <img :src=" 'banners_empresas/' + foto.url_foto" width="200" />
  ...
  components: {
   ...
   methods:{
     ...
     listarBanners(){
        ...
        axios.get('banners-empresa/listar').then(function (response) {

            var respuesta= response.data;
            me.arBanners = respuesta.banners;
        ...
        Swal.fire({
                    ...
                    cancelButtonText: 'No, Cancelar'
                      ...
                      if (result.value) {
                             ...
                             axios.post('banners-empresa/eliminar', {
