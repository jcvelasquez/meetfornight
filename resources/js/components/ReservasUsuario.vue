<template>
  <form action="#" method="post">
      ...
      <div class="servicios_seleccionados espacio-reservas" v-show="mostrarReserva" >
        ...
        <h2 class="sub-tit"><i class="icon-calendar esp-icono-bio"></i>GESTIÓN DE RESERVAS</h2>

        <!-- SECCION INTERIOR DE DATOS -->
        <div class="form-row" style="margin-top:20px;">
            <div class="col-lg-6 col-sm-12">
                 <i class="fa fa-clock-o"></i> <strong>Profesional:</strong> {{usuarioReserva.nombre}}
            </div>
            <div class="col-lg-6 col-sm-12">
            ...
            <tbody class="resultado-fake">
              ...
              <template v-if="arReservas.length > 0">
                    ...
                    <tr v-for="reserva in arReservas" :key="reserva.id">
                        ...
                        <td v-text="reserva.profesional.nombre"></td>
              ...
              <template v-else>
                    <tr>
                        <td colspan="7" scope="row" align="center"> No se registraron reservas en tu cuenta </td>
                    </tr> 
              </template>
    ...
    export default {
        ...
        methods:{
            ...
            listarReservas(){
                  ...
                  axios.get('/reservas-usuario/listar').then(function (response) {
            ...
            seleccionarReserva(reserva){
                ...
                me.usuarioReserva = reserva.profesional;
