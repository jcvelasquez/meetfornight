...
<!--         <li><a href="{{ url('planes-empresa') }}" class="{{ request()->is('planes-empresa') ? 'menu-lateral-usuario-active' : '' }}"><span><i class="icon-people esp-icono-bio"></i>PLANES</span><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></li>
 -->
        ...
        <li><a href="{{ url('banners-empresa') }}" class="{{ request()->is('banners-empresa') ? 'menu-lateral-usuario-active' : '' }}"><span><i class="icon-video esp-icono-bio"></i>BANNERS</span><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></li>
 
        <li><a href="{{ url('estadisticas-empresa') }}" class="{{ request()->is('estadisticas-empresa') ? 'menu-lateral-usuario-active' : '' }}"><span><i class="icon-estadisticas esp-icono-bio"></i>ESTADISTICAS</span><span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></li>
