<div class="cuerpo-perfil">
  ...
  <section>
          ...
          <div class="espacio-reservas">
            ...
            <div class="reserva-info">
              <ul>
                ...
                <li>
                  <div class="reserva-info-morado">Piercing(s)</div>
                  <div class="reserva-info-plomo">Sí</div>
                </li>
                <li>
          ...
          <div class="espacio-reservas">
            ...
            <div class="reserva-info">
              <ul>
                ...
                <li>
                  <div class="reserva-info-morado">Corresponde a la(s) foto(s)</div>
                  <div class="fucsia"><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i></div>
                </li>
              </ul>
            </div>
    ...
    <div class="form-row">
        <button type="submit" class="btn btn-busqueda-detallada rojito">ACTIVAR</button>
      </div>
  </section>
