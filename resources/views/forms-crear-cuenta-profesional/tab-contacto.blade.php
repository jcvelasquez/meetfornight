<div class="row justify-content-center cuerpo-perfil">
      <div class="col-lg-8 col-sm-12">
          <form action="crear-cuenta-5.php" method="post">
          ...
          <div class="bloques-de-perfil">
            ...
            <div class="form-row espacio-campos obligando-columna">
                  <div class="bloque-opcion">
                    ...
                    <label class="custom-control-label custom-control-label-espacio" for="mensaje"><span>Mensaje</span><p>Los <strong>usuarios conectados</strong> pueden enviarte un mensaje (con un adjunto). Puedes leer contestar a los mensajes a través del dashboard.</p></label>
                    </div>
                  </div>
                  <div class="bloque-opcion">
                    <div class="no-pad custom-control custom-radio custom-control-inline no-margin-right-check col-lg col-md-12 col-sm-12">
                    <input type="radio" id="correos" name="customRadioInline1" class="custom-control-input">
                    <label class="custom-control-label custom-control-label-espacio" for="correos"><span>Correos</span><p>Los <strong>usuarios anónimos</strong> conectados pueden enviarte un correo a través de la web. Puedes enviar respuestas a través de tu correo (tu correo no sera visible en la pagina web).</p></label>
                    </div>
                  </div>
                  <div class="bloque-opcion">
                    <div class="no-pad custom-control custom-radio custom-control-inline no-margin-right-check col-lg col-md-12 col-sm-12">
                    <input type="radio" id="ninguna" name="customRadioInline1" class="custom-control-input">
                    <label class="custom-control-label custom-control-label-espacio" for="ninguna"><span>Ninguna de las anteriores</span><p>No quieres recibir mensajes o correos de los visitantes. Serás contactada solamente por teléfono.</p></label>
                    </div>
                  </div>
            </div>
          </div>
